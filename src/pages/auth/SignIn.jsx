...
const SignIn = () => {
  ...
  const submit = handleSubmit((data) => {
    ...
    signInUser({ email, password }).then((res) => {
      if (res) {
        ...
        Swal.fire({
          icon : 'error',
          title : 'Please check If you are a user',
          showClass: {
            popup: `
              animate__animated
              animate__fadeInUp
  ...
  return (
    <>
      ...
      <div className="w-full h-[100vh] flex justify-center items-center bg-[rgb(228,172,102)] relative" style={{ background: "linear-gradient(90deg, rgba(228,172,102,1) 0%, rgba(215,214,79,1) 35%, rgba(205,65,117,1) 100%)" }}>
